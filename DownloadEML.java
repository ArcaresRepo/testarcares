...
import it.cbt.wr.cgfdgdore.script.janino.WrRuleClassBody;
...
public class DownloadEML implements WrRuleClassBody {
    ...
    public Object run(Map parameters) {
        ...
        try {
            ...
            ContainedEntities incomingMails = entity.getContainedEntities("incomingMail");
            if(incomingMails != null && incomingMails.size() == 1){
                Entity incomingMail = (Entity) incomingMails.get(0);
                ContainedEntities originalMessages = incomingMail.getContainedEntities("originalMessage");
